	...
	public Response insererOuModifierVoisinageLegume(BmVoisinageLegumeDao b,boolean ajout) {
		try {
			...
			if(ajout) {
				...
				List<BmVoisinageLegumeDao> l = VoisinageLegumeDao.getListeVoisinageLegume(b.getIdLegumeVoisinage(),b.getType());
				...
				VoisinageLegumeDao.updateDescriptionVoisinageCulture(b);
			}
